...
def call_peak(input_bigwig, control_bigwig, output_dir, qvalue, pvalue, broad,  window_size, thread):
    ...
    for chrom in chroms:
        ...
        tmp_peak_list = filter_peak(tmp_peak_list, pvalue, qvalue)
        ...
        with open(output_bed,'a') as peak_file:
            for i in range(len(tmp_peak_list)):
                start_index, end_index, pval = tmp_peak_list[i]
...
if __name__ == '__main__':
    ...
    output_path=call_peak(input_bigwig, control_bigwig, output_dir, qvalue, pvalue, broad,  window_size, thread)
