...
then
    ...
    then
        ...
        java -Xmx$maxmem -Xms$maxmem -jar $juicer_tool_path pre -n $input_pairs $output_prefix.hic $chromsizefile -r $reslist -q $mapqfilter
    elif [[ ! -z $custom_res ]]
    then
        java -Xmx$maxmem -Xms$maxmem -jar $juicer_tool_path -n $input_pairs $output_prefix.hic $chromsizefile -r $custom_res -q $mapqfilter
    else
        java -Xmx$maxmem -Xms$maxmem -jar $juicer_tool_path -n $input_pairs $output_prefix.hic $chromsizefile -q $mapqfilter
    fi
fi
