...
def plot_distribution(input_bw, window_size, stride, output_fig):
...
if __name__ == '__main__':
    if len(sys.argv)!=5:
        print("Usage: python3 bigwig_peak_distribution.py [input.bw] [window_size] [stride] [output_fig]")
    ...
    plot_distribution(input_bw, window_size, stride, output_fig)
